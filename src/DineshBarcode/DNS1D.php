                        ...
                        switch ($seq[0]) {
                            case 'A':
                                    if (0 == $key) {
                                        ...
                                        if ((1 == $seq[2]) && ($key > 0) && ('B' == $sequence[($key - 1)][0]) && (!isset($sequence[($key - 1)][3]))) {
                            ...
                            case 'B':
                                    if (0 == $key) {
                                        ...
                                        if ((1 == $seq[2]) && ($tmpchr >= 241) && ($tmpchr <= 244) && isset($sequence[($key + 1)]) && ('B' != $sequence[($key + 1)][0])) {
                                        ...
                                        if ((1 == $seq[2]) && ($key > 0) && ('A' == $sequence[($key - 1)][0]) && (!isset($sequence[($key - 1)][3]))) {
                                            // single character shift
                                            $code_data[] = 98;
                                            // mark shift
                                            $sequence[$key][3] = true;
