    ...
    public function __construct($code)
    {
        ...
        if ($params[11] > $nd) {
            ...
            if (ENC_EDF == $this->last_enc) {
                ...
                $cw[] = 124;
                $nd++;
            } elseif ((ENC_ASCII != $this->last_enc) && (ENC_BASE256 != $this->last_enc)) {
                // switch to ASCII encoding
                $cw[] = 254;
                $nd++;
            }
    ...
    protected function isCharMode($chr, $mode)
    {
        ...
        switch ($mode) {
            ...
            case ENC_C40:  // Upper-case alphanumeric
                    $status = ((32 == $chr) || (($chr >= 48) && ($chr <= 57)) || (($chr >= 65) && ($chr <= 90)));
                    break;

            case ENC_TXT:  // Lower-case alphanumeric
                    $status = ((32 == $chr) || (($chr >= 48) && ($chr <= 57)) || (($chr >= 97) && ($chr <= 122)));
                    break;

            case ENC_X12:  // ANSI X12
                    $status = ((13 == $chr) || (42 == $chr) || (62 == $chr));
                    break;
            ...
            case ENC_BASE256:  // Function character (FNC1, Structured Append, Reader Program, or Code Page)
                    $status = ((232 == $chr) || (233 == $chr) || (234 == $chr) || (241 == $chr));
                    break;
            ...
            switch ($enc) {
                ...
                case ENC_X12:  // ANSI X12
                        ...
                        do {
                            ...
                            if (isset($charset[$chr])) {
                                ...
                                } elseif ((ENC_C40 == $enc) && isset($this->chset['S3C'][$chr])) {
                                    $temp_cw[] = 2; // shift 3
                                    $shiftset  = $this->chset['S3C'];
                                } elseif ((ENC_TXT == $enc) && isset($this->chset['S3T'][$chr])) {
                                    $temp_cw[] = 2; // shift 3
                ...
                case ENC_EDF:  // F. While in EDIFACT (EDF) encodation
                        ...
                        while ($epos < $data_lenght) {
                            ...
                            if ((4 == $field_lenght) || ($epos == $data_lenght)) {
                                if ($field_lenght < 4) {
