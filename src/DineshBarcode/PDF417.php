            ...
            if ($seq[1] > 0) {
                ...
                foreach ($textseq[1] as $txtseq) {
                    ...
                    if ($txtseq[1] > 0) {
                        ...
                        if ('' !== $prevtxtseq) {
                            // add BYTE sequence
                            if ((1 == \strlen($prevtxtseq)) && ((\count($sequence_array) > 0) && (900 == $sequence_array[(\count($sequence_array) - 1)][0]))) {
                        ...
                        if (($k = array_search($chval, $this->textsubmodes[$submode])) !== false) {
                            ...
                            for ($s = 0; $s < 4; $s++) {
                                ...
                                if (($s != $submode) && (($k = array_search($chval, $this->textsubmodes[$s])) !== false)) {
                                    ...
                                    if (((($i + 1) == $codelen) || ((($i + 1) < $codelen) && (false !== array_search(\ord($code[($i + 1)]), $this->textsubmodes[$submode])))) && ((3 == $s) || ((0 == $s) && (1 == $submode)))) {
